...
脚注的用法很简单，只需要在段落中需要插入脚注的地方标注一个符号，再在段落后对这个符号进行解释即可。比如这是一个简单的脚注，[[1]](https://publish.obsidian.md/#fn-1-a550dedeae223199) 这是一个长一些的脚注。[[2]](https://publish.obsidian.md/#fn-2-a550dedeae223199)

你也可以使用行内脚注。[[3]](https://publish.obsidian.md/#fn-3-a550dedeae223199)
...
1. 很有用！[↩︎](https://publish.obsidian.md/#fnref-1-a550dedeae223199)
...
2. 这是一个可以写长段落或者代码的地方。
    ...
    这样你就可以在脚注中添加任意数量的段落了。[↩︎](https://publish.obsidian.md/#fnref-2-a550dedeae223199)
    
3. 请注意符号^需要在方括号外 [↩︎](https://publish.obsidian.md/#fnref-3-a550dedeae223199)
